...
const StockDashboard: React.FC = () => {
  ...
  const fetchSearchResults = async (searchQuery: string) => {
    ...
    try {
      const apiKey = "ctojfdhr01qpsuefplsgctojfdhr01qpsuefplt0"; // Replace with your Finnhub API key
      const response = await axios.get("https://finnhub.io/api/v1/search", {
        params: {
          q: searchQuery,
          exchange: "US", // Change to desired exchange, e.g., NSE for India
          token: apiKey,
        },
      });
  ...
  return (
    <div className="md:p-[20px]">
      <p className="text-sm p-[20px] md:p-0">International Stocks</p>
      <div
            ...
            {results.map((result) => (
              <li
                ...
                style={{
                  ...
                  backgroundColor:
                    symbol === result.symbol ? "#f0f8ff" : "#fff",
                }}
              >
