        ...
        {rows > 0 ? (
          ...
          <div className="relative">
            <input
              ...
              value={value}
              placeholder={placeholder}
              className={`block w-full font-normal rounded-md border-0 py-1.5 text-black bg-[#0D1117] shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 ${sx}`}
              onChange={handleTextChange}
            />
            <div
              className="cursor-pointer absolute z-50 right-2 top-2"
